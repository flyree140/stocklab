...
export default function StockLab() {
  ...
  const equityChart = useMemo(() => {
    ...
    return btResult.curve.map((p) => ({ t: p.t, equity: p.equity }));
  }, [btResult]);
        ...
        <header className="rounded-2xl border bg-white p-5 shadow-sm">
          ...
          <div className="mt-4 grid gap-3 md:grid-cols-12">
            <div className="md:col-span-4">
              ...
              <input className="mt-1 w-full rounded-xl border bg-white px-3 py-2 text-sm" value={search} onChange={(e) => setSearch(e.target.value)} placeholder="輸入代號或名稱" />
              <div className="mt-2 text-xs text-slate-600">股票下拉選單</div>
              <select className="mt-1 w-full rounded-xl border bg-white px-3 py-2 text-sm" value={selected} onChange={(e) => setSelected(e.target.value)}>
            ...
            <div className="md:col-span-3">
              ...
              <input className="mt-1 w-full rounded-xl border bg-white px-3 py-2 text-sm" value={symbol} onChange={(e) => setSymbol(e.target.value.toUpperCase())} />
              <div className="mt-2 text-xs text-slate-600">Provider</div>
              <select className="mt-1 w-full rounded-xl border bg-white px-3 py-2 text-sm" value={provider} onChange={(e) => setProvider(e.target.value as Provider)}>
            ...
            <div className="md:col-span-3">
              ...
              <input className="mt-1 w-full rounded-xl border bg-white px-3 py-2 text-sm" type="date" value={dateFrom} onChange={(e) => setDateFrom(e.target.value)} />
              <div className="mt-2 text-xs text-slate-600">To</div>
              <input className="mt-1 w-full rounded-xl border bg-white px-3 py-2 text-sm" type="date" value={dateTo} onChange={(e) => setDateTo(e.target.value)} />
            </div>
          ...
          <div className="mt-4 rounded-2xl border bg-slate-50 p-4">
            ...
            <div className="mt-3 grid gap-3 md:grid-cols-12">
              <div className="md:col-span-4">
                ...
                <select className="mt-1 w-full rounded-xl border bg-white px-3 py-2 text-sm" value={strategy} onChange={(e) => setStrategy(e.target.value as StrategyId)}>
                ...
                {strategy === "trend_sma" ? (
                  <>
                    <label className="text-xs text-slate-600">
                      SMA fast
                      <input className="mt-1 w-full rounded-xl border bg-white px-2 py-1 text-sm" type="number" value={btFast} onChange={(e) => setBtFast(Number(e.target.value))} />
                    </label>
                    <label className="text-xs text-slate-600">
                      SMA slow
                      <input className="mt-1 w-full rounded-xl border bg-white px-2 py-1 text-sm" type="number" value={btSlow} onChange={(e) => setBtSlow(Number(e.target.value))} />
                    </label>
                    <div />
                    <div />
                  </>
                  ...
                  <>
                    <label className="text-xs text-slate-600">
                      RSI period
                      <input className="mt-1 w-full rounded-xl border bg-white px-2 py-1 text-sm" type="number" value={btRsiPeriod} onChange={(e) => setBtRsiPeriod(Number(e.target.value))} />
                    </label>
                    <label className="text-xs text-slate-600">
                      RSI entry (&lt;)
                      <input className="mt-1 w-full rounded-xl border bg-white px-2 py-1 text-sm" type="number" value={btRsiEntry} onChange={(e) => setBtRsiEntry(Number(e.target.value))} />
                    </label>
                    <label className="text-xs text-slate-600">
                      RSI exit (&gt;)
                      <input className="mt-1 w-full rounded-xl border bg-white px-2 py-1 text-sm" type="number" value={btRsiExit} onChange={(e) => setBtRsiExit(Number(e.target.value))} />
                    </label>
                    <div />
                  </>
                )}
            ...
            <div className="mt-3 grid gap-2 sm:grid-cols-4">
              <label className="text-xs text-slate-600">
                fee (bps)
                <input className="mt-1 w-full rounded-xl border bg-white px-2 py-1 text-sm" type="number" value={feeBps} onChange={(e) => setFeeBps(Number(e.target.value))} />
              </label>
              <label className="text-xs text-slate-600">
                slippage (bps)
                <input className="mt-1 w-full rounded-xl border bg-white px-2 py-1 text-sm" type="number" value={slipBps} onChange={(e) => setSlipBps(Number(e.target.value))} />
              </label>
              <label className="text-xs text-slate-600">
                ATR stop k
                <input className="mt-1 w-full rounded-xl border bg-white px-2 py-1 text-sm" type="number" value={atrStopK} onChange={(e) => setAtrStopK(Number(e.target.value))} />
              </label>
            ...
            <div className="mt-3 grid gap-2 sm:grid-cols-3">
              ...
              <label className="text-xs text-slate-600">
                volRatio threshold
                <input className="mt-1 w-full rounded-xl border bg-white px-2 py-1 text-sm" type="number" value={volumeGateThr} onChange={(e) => setVolumeGateThr(Number(e.target.value))} />
              </label>
            ...
            <div className="mt-3 grid gap-2 sm:grid-cols-4">
              ...
              <label className="text-xs text-slate-600">
                ...
                <input className="mt-1 w-full rounded-xl border bg-white px-2 py-1 text-sm" type="number" value={eventCountThr} onChange={(e) => setEventCountThr(Number(e.target.value))} />
              </label>
              <label className="text-xs text-slate-600">
                scale (0~1)
                <input className="mt-1 w-full rounded-xl border bg-white px-2 py-1 text-sm" type="number" value={eventScale} onChange={(e) => setEventScale(Number(e.target.value))} />
              </label>
            ...
            <div className="mt-3">
              ...
              <div className="mb-3 rounded-2xl border bg-slate-50 p-3">
                <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
                  <label className="text-xs text-slate-600">
                    時間尺度（Timeframe）
                    <select className="mt-1 w-full rounded-xl border bg-white px-3 py-2 text-sm" value={tf} onChange={(e) => setTf(e.target.value as Timeframe)}>
                  ...
                  <label className="text-xs text-slate-600">
                    ...
                    <input
                      ...
                      onChange={(e) => setChartBars(Number(e.target.value))}
                    />
                  ...
                  <label className="text-xs text-slate-600">
                    ...
                    <input
                      ...
                      onChange={(e) => setChartEnd(Number(e.target.value))}
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="rounded-2xl border bg-white p-4 shadow-sm">
              ...
              <div className="mt-3">
                ...
                <input className="mt-1 w-full rounded-xl border bg-white px-3 py-2 text-sm" value={eventsQuery} onChange={(e) => setEventsQuery(e.target.value)} />
              </div>
              ...
              <div className="mt-3 grid gap-2 sm:grid-cols-2">
                ...
                <label className="text-xs text-slate-600">
                  語言
                  <select className="mt-1 w-full rounded-xl border bg-white px-3 py-2 text-sm" value={eventLang} onChange={(e) => setEventLang(e.target.value as EventLang)}>
                ...
                <label className="text-xs text-slate-600">
                  來源國家
                  <select className="mt-1 w-full rounded-xl border bg-white px-3 py-2 text-sm" value={eventCountry} onChange={(e) => setEventCountry(e.target.value as EventCountry)}>
                    <option value="any">Any</option>
              ...
              <div className="mt-3">
                ...
                <input className="mt-1 w-full" type="range" min={0} max={12} value={eventMinScore} onChange={(e) => setEventMinScore(Number(e.target.value))} />
            ...
            <div className="rounded-2xl border bg-white p-4 shadow-sm">
              ...
              <div className="mt-3 grid gap-2 sm:grid-cols-2">
                <label className="text-xs text-slate-600">
                  投資風格（Style）
                  <select className="mt-1 w-full rounded-xl border bg-white px-3 py-2 text-sm" value={investStyle} onChange={(e) => setInvestStyle(e.target.value as InvestStyle)}>
                ...
                <label className="text-xs text-slate-600">
                  風險承受度（Risk）
                  <select className="mt-1 w-full rounded-xl border bg-white px-3 py-2 text-sm" value={riskLevel} onChange={(e) => setRiskLevel(e.target.value as RiskLevel)}>
                ...
                <label className="text-xs text-slate-600">
                  期限（Years）
                  <input className="mt-1 w-full rounded-xl border bg-white px-3 py-2 text-sm" type="number" value={horizonYears} onChange={(e) => setHorizonYears(Number(e.target.value))} />
                </label>
                <label className="text-xs text-slate-600">
                  單一標的上限（%）
                  <input className="mt-1 w-full rounded-xl border bg-white px-3 py-2 text-sm" type="number" value={maxSinglePct} onChange={(e) => setMaxSinglePct(Number(e.target.value))} />
                </label>
              </div>
